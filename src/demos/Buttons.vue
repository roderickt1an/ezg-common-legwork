    ...
    <page-content>
      <div class='content-padded'>
        ...
        <div class="content-block">
          ...
          <p>
            <m-button type="light">light button</m-button>
          </p>
          <p>
            <m-button type="danger">danger button</m-button>
          </p>
          <p>
            <m-button type="warning">warning button</m-button>
          </p>
          <p>
            <m-button type="danger" :disabled="true">disabled button</m-button>
          </p>
        </div>
        <div class="content-block">
          <p>
          ...
          <p>
            <m-button size="large" :round="true">large Round button</m-button>
          </p>
        </div>
        <div class="content-block">
          <p>
...
if (this.smdk === '上门打卡') {
document.getElementById('fuwusj').style = 'display:block'
let t = 0
